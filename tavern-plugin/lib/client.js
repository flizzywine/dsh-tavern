...
`;
		...
		function buildTavernFrameDocument(input) {
			...
			const helperDependencies = input && input.helperContext
				? '<script src="' + tavernStaticAssetUrl('https://cdn.jsdelivr.net/npm/jquery@3.7.1/dist/jquery.min.js') + '"><\/script><script src="' + tavernStaticAssetUrl('https://cdn.jsdelivr.net/npm/lodash@4.18.1/lodash.min.js') + '"><\/script><script src="' + tavernStaticAssetUrl('https://cdn.jsdelivr.net/npm/vue@3.5.41/dist/vue.global.prod.js') + '"><\/script>'
				: '';
		...
		function buildTavernHelperScriptDocument(input) {
			...
			return '<!doctype html><html><head><meta charset="utf-8">'
				...
				+ '<script src="' + tavernStaticAssetUrl('https://cdn.jsdelivr.net/npm/vue@3.5.41/dist/vue.global.prod.js') + '"><\/script>'
