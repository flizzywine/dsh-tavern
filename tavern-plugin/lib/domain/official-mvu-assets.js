...
export const OFFICIAL_MVU_VERSION = Object.freeze({
  ...
  bundleSha256: '3b510787a95c7a51523dcbbb2beff5f13b3bd069abf973dec1fdb1f21eeea61f',
  assetUrl: '/api/dsh-tavern/vendor/magvarupdate/bundle.js'
})

const bundleUrl = new URL('../vendor/magvarupdate/upstream/artifact/bundle.js', import.meta.url)
let bundlePromise
