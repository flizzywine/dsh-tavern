...
人物外貌不充分时，优先用 character_design_read 按姓名读取已有设计；不确定姓名可先读索引。返回 sources 可作为 evidence，quote 引用其中 text 的连续原文。默认形象不是当轮衣着、动作或站位的证据；本轮明确正文和状态优先，不得根据设计中的剧情潜力演绎尚未发生的事情。
