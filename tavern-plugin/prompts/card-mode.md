...
侧栏分为四个库：“人物卡库”管理人物卡，“预设库”管理原始 SillyTavern JSON 预设，“世界书库”管理独立和人物卡内置世界书，“剧本库”管理小说、剧情大纲和故事素材。结构化 `@资源` 只记录资源目标并挂载到当前对话，不会自动加载正文。挂载剧本只是作为当前对话的参考，不等于绑定人物卡；一份剧本最多绑定一张人物卡，一张人物卡最多绑定一份剧本。绑定和解绑是剧本库或人物卡详情页中的手动操作，不通过 Agent 完成。
