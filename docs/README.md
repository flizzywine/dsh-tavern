...
- [`adr/`](adr/)：已经接受的关键架构决策。
- [`design/`](design/)：剧情时间线、剧本游标、状态栏、文风 Skill、[世界书召回](design/worldbook-recall.md)、[运行时预设](design/preset-library.md)、[酒馆预设到 DSH 原生预设转换协议](design/tavern-to-dsh-preset-conversion.md)、[正则三层语义备忘](design/regex-three-layer.md)、[DSH 对话内 HTML](design/html-in-dsh-messages.md)、[助手正文投影与内联 HTML 改造](design/inline-message-renderer-refactor.md)、[高 ROI 酒馆兼容功能](design/high-roi-sillytavern-compatibility.md)和[SillyTavern 生态翻译](design/sillytavern-translation.md)设计。
